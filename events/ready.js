...
module.exports = (client) => {
    ...
    if (!table["count(*)"]){
        sql.prepare("CREATE TABLE profiles (id TEXT PRIMARY KEY, user TEXT, points INTEGER, email TEXT);").run();
    ...
    client.setProfile = sql.prepare("INSERT OR REPLACE INTO profiles (id, user, points, email) VALUES (@id, @user, @points, @email);"); 
}